            ...
            <div class="col-md-10 col-md-offset-1">
                <div class="form-group row">
                    ...
                    <div class="col-md-5 col-sm-6">
                        <input type="text" name="first_name" class="form-control" placeholder="Prénom" value="{{ Auth::user()->first_name }}" required />
                    </div>
                </div>
                <div class="form-group row">
                    <label for="text" class="col-md-4 col-sm-6 control-label">Nom :</label>
                    <div class="col-md-5 col-sm-6">
                        <input type="text" name="last_name" class="form-control" placeholder="Nom" value="{{ Auth::user()->last_name }}" required />
                    </div>
                </div>
                <div class="form-group row">

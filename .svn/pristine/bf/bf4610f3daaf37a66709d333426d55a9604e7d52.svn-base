...
<?php
    ...
    require_once(dirname(__FILE__).'C:\Program Files (x86)\EasyPHP-DevServer-14.1VC11\data\localweb\myProject\resources\views\project\bookmark.php');
    try
    {
        $html2pdf = new HTML2PDF('P', 'A4', 'fr', true, 'UTF-8', 0);
        $html2pdf->writeHTML($content, isset($_GET['vuehtml']));
        $html2pdf->createIndex('Sommaire', 25, 12, false, true, 1);
        $html2pdf->Output('C:\Users\koria\Desktop\html2pdf-4.5.1\html.pdf');
    }

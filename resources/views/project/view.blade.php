    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="text-muted" style="">
                ...
                <h5>
                    {!! $project->getStatus() !!}
                    <a href="{{ url('/project/'.$project->id .'/historic') }}">
                        <span class="label label-default">
                            <i class="glyphicon glyphicon-time"></i>
                            Historique
                        </span>
                    </a>
                    <a href="{{ url('/project/'.$project->id .'/files') }}" style="margin-left: 5px">
                        <span class="label label-default">
                    ...
                    @if($project->status == '3')
                        <a href="{{url('project/'.$project->id.'/show')}}" style="margin-left: 5px">
                            <span class="label label-default">
                ...
                <div>
                    @if( $project->status =='1')
                        <a type="submit" class="btn btn-success" style="...."
                           href="{{ url('project/'.$project->id.'/end') }}">
                        ...
                        <a type="submit" class="btn btn-warning" style="margin: 5px 0px;"
                           href="{{ url('project/'.$project->id.'/cancel') }}">
                            <i class="glyphicon glyphicon-remove"></i> &nbsp;Annuler
                        </a>
                        @endif
                                <!--restauration-->
                        @if($project->status=='2') <a type="button" class="btn btn-success" style="..."
                                                      href="{{url('project/'.$project->id.'/restore')}}">Restaurer</a>
                        @endif
